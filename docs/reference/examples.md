...
| `examples/streaming` | Boundary swaps plus out-of-order stream patches with reveal ordering, error settling, and recovery |
| `examples/swap-dedupe` | `ifChanged` swap dedupe with live and inline bindings |
