...
<body>
    ...
    <script>
        ...
        function updateFullName() {
            fullNameDisplay.textContent = `${firstNameSignal.value} ${lastNameSignal.value}`;
        }
...
<body>
    <define-signal data-id="user" initial-value='{"name": "John Doe", "age": 30, "hobbies": ["reading", "coding"]}'></define-signal>
